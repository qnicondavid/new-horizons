...
CREATE INDEX idx_group_package_package_id ON group_package(package_id);
CREATE INDEX idx_guide_package_group_package_id ON guide_package(group_package_id);
